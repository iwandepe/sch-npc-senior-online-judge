...
class Event extends \App\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Event' . "\0" . 'eventid', '' . "\0" . 'App\\Entity\\Event' . "\0" . 'eventtime', '' . "\0" . 'App\\Entity\\Event' . "\0" . 'endpointtype', '' . "\0" . 'App\\Entity\\Event' . "\0" . 'endpointid', '' . "\0" . 'App\\Entity\\Event' . "\0" . 'action', '' . "\0" . 'App\\Entity\\Event' . "\0" . 'content', '' . "\0" . 'App\\Entity\\Event' . "\0" . 'cid', '' . "\0" . 'App\\Entity\\Event' . "\0" . 'contest'];
        }
