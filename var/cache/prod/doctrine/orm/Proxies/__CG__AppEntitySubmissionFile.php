 ...
 */
class SubmissionFile extends \App\Entity\SubmissionFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\SubmissionFile' . "\0" . 'submitfileid', '' . "\0" . 'App\\Entity\\SubmissionFile' . "\0" . 'submitid', '' . "\0" . 'App\\Entity\\SubmissionFile' . "\0" . 'filename', '' . "\0" . 'App\\Entity\\SubmissionFile' . "\0" . 'rank', '' . "\0" . 'App\\Entity\\SubmissionFile' . "\0" . 'submission', '' . "\0" . 'App\\Entity\\SubmissionFile' . "\0" . 'sourcecode'];
        }
