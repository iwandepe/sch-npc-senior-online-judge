 ...
 */
class Balloon extends \App\Entity\Balloon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Balloon' . "\0" . 'balloonid', '' . "\0" . 'App\\Entity\\Balloon' . "\0" . 'submitid', '' . "\0" . 'App\\Entity\\Balloon' . "\0" . 'done', '' . "\0" . 'App\\Entity\\Balloon' . "\0" . 'submission'];
        }
