...
include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/framework-bundle/CacheWarmer/AbstractPhpFileCacheWarmer.php';
include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/framework-bundle/CacheWarmer/AnnotationsCacheWarmer.php';
